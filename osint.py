...
email = "callid.sync@gmail.com"
password = "GreatBritainSucks254"
phoneNumberOwner = ""
phoneNumberOwner1 = ""
tupleOutput = False
...
def index():
    ...
    if request.method == "POST":
        ...
        if command == "help":
            ...
            try:
                return render_template("showoptions.html", phone_number=phone_number, social_media=social_media,
                                       get_links=get_links, spam_risk=spam_risk, find_owner=find_owner,
                                       get_comments=get_comments)
            except:
...
def featureOnProgress():
    ...
    if get_comments == "Added":
        ...
        comments2 = "Feature On Progress"
    else:
        comments = "Feature Not Selected";
        comments2 = "Feature Not Selected"
    if find_owner == "Added":
        phoneNumberOwner = "Feature On Progress"
        phoneNumberOwner1 = "Feature On Progress"
    else:
        phoneNumberOwner = "Feature Not Selected";
        phoneNumberOwner1 = "Feature Not Selected"
...
if __name__ == "__main__":
    try:
        ...
        app.run(ip_address, 8080, debug=True)
